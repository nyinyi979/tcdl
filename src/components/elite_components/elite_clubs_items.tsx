        ...
        <div className={`w-full py-20 text-center ${bg6Class}`}>
            ...
            <div className="grid md:grid-cols-2 grid-cols-1 llg:w-[75%] lg:w-[88%] md:w-11/12 w-10/12 lg:gap-16 md:gap-8 gap-12 mx-auto text-left xll:py-10 lg:py-5">
                ...
                <div key={Math.random()*1000} className="rounded-xl md:h-[28rem] md:w-full ssm:w-[74%] relative pb-24 w-fit mx-auto h-fit bg-gray-200 mt-4">
                    <div className={`oswald font-[500] w-full md:text-3xl text-2xl rounded-t-xl px-5 py-5 text-white bg-gradient-to-r ${value}`}>{items[index]}</div>
                    <div className="pb-3 px-3">
                        <ul className="c pl-1 pt-5 md:text-xl ssm:text-lg xs:text-lg text-base font-[500] ml-4 text-t_violet lg:leading-[2.5rem] leading-[2rem]">
                    ...
                    <div className="absolute left-7 bottom-10 text-gray-700 font-[600]">
                        <span className="oswald llg:text-5xl lg:text-4xl xs:text-3xl text-2xl text-[#4b2c64] font-[800]">${prices[index]}</span>
                        <sub className="oswald relative bottom-0 lg:text-[27px] xl:text-2xl xs:text-xl text-lg font-[600]">/Month</sub>
                    </div>
                    <div className="absolute sm:right-10 sm:bottom-8 xl:px-6 xl:py-5 lg:px-3 lg:py-4 lg:text-base xl:text-lg 
