    ...
    return(
        <div className={`w-full py-20 text-center ${bg6Class}`}>
            ...
            <div className="grid md:grid-cols-2 grid-cols-1 llg:w-[75%] lg:w-[88%] md:w-11/12 w-10/12 lg:gap-16 md:gap-8 gap-12 mx-auto text-left xll:py-10 lg:py-5">
                ...
                {bg.map((value , index)=>(
                <div key={index} className="rounded-xl md:h-[27rem] md:w-full ssm:w-[74%] relative pb-24 w-fit mx-auto h-fit bg-gray-200 mt-4">
                    <div className={`oswald font-[500] w-full text-3xl rounded-t-xl px-5 py-4 text-white bg-gradient-to-r ${value}`}>{items[index]}</div>
                    <div className="pb-3 px-2">
                        <ul className="c pl-1 pt-5 text-lg font-[400] ml-4 text-t_violet lg:leading-[2.5rem] leading-[2rem]">
