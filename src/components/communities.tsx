...
export default function Communities(){
    return(
        <div className={`text-white text-center h-fit w-full lg:pt-20 lg:pb-28 py-12 ${bg5Class}`}>
            <div className={`xl:w-5/6 md:w-[90%] xs:w-[85%] w-[80%] py-8 mx-auto font-[600] xxl:leading-[3.4rem] 
            xxl:text-[2.3rem] lg:text-2xl lg:leading-[3rem] ssm:text-xl text-lg leading-10`}>
