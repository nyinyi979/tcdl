...
export default function Communities(){
    return(
        <div className={`text-white text-center h-fit w-full lg:pt-20 lg:pb-28 py-12 ${bg5Class}`}>
            <div className={`xl:w-5/6 llg:w-[91%] md:w-[85%] xs:w-[82%] w-[90%] lg:py-8 pt-2 pb-8 mx-auto font-[600] xxl:leading-[3.4rem] 
            xxl:text-[2.3rem] lg:text-2xl lg:leading-[3rem] md:leading-[2.4rem] xs:leading-10 xs:text-xl text-lg leading-10`}>
