...
export default function Footer(){
    ...
    const iconClass ="text-dark_violet hover:rotate-[20deg] hover:text-black rounded-full w-12 h-12 p-3 bg-blue cursor-pointer hover:bg-primary duration-300";
    return(
        <div className="bg-dark_violet py-12">
            ...
            <div className="flex lg:w-[20%] md:w-[40%] w-[50%] mx-auto my-10" style={{justifyContent:'space-between'}}>
            ...
            <a href="/"><img src="/footer-logo-e48cc106.png" alt="" className="w-64 h-fit bg-cover md:mt-12 mt-4 mx-auto"/></a>
            <div className="text-light_blue text-center pt-10 pb-8">
