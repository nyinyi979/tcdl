...
export const bg2Class = `md:bg-[top_center_-300px] md:bg-[center_left_0px]  bg-[center_left_-450px] bg-cover [background-image:url('/TheCardDon_tLie-TDCL-Tarot-Rune-Photo-02.jpg')] bg-no-repeat`
