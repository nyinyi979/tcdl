...
//Class for quotation
export const quoteClass = `leading-8 xll:py-32 xl:py-24 md:py-20 xsm:py-[64px] py-16 relative
    before:[background-image:url('/left_quote.png')] before:absolute before:w-[70px] before:h-[70px] xll:before:left-[44%] md:before:left-[46%] xsm:before:left-[43%] xs:before:left-[42%] before:left-[38%] before:top-0 xl:before:w-[120px] xl:before:h-[120px] before:bg-cover
    after:[background-image:url('/right_quote.png')] after:absolute  after:w-[70px] after:h-[70px] xll:after:left-[44%] md:after:left-[46%] xsm:after:left-[43%] xs:after:left-[42%] after:left-[38%] after:bottom-0 xl:after:w-[120px] xl:after:h-[120px] after:bg-cover  `
