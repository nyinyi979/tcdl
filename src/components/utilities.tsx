...
export const h2Class = "oswald md:font-[600] font-[500] xxl:text-5xl xxl:mr-16 xll:text-[2rem] xll:leading-[2.7rem] xll:mr-6 xl:text-[1.8rem] xl:mr-4 xl:leading-9 md:text-[1.3rem] md:leading-8 mr-5 xs:text-[1.4rem] text-[1.2rem]"
...
export const bg3Class = `[background-image:url('/bg3.jpg')] bg-fixed md:bg-[center_left_0px] bg-[center_left_-400px] bg-repeat bg-cover`
