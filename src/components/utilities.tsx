...
export const h1Class = "oswald md:font-[600] font-[500] xxl:text-[4.6rem] xxl:leading-[4.5rem] xxl:mr-12 font-bold xll:text-[3rem] xll:mr-4 xl:text-[2.5rem] xl:mr-6 md:text-[2.3rem] md:mr-4 md:leading-[3.8rem] text-4xl mr-2 leading-[3.1rem] "
export const h2Class = "oswald md:font-[600] font-[500] xxl:text-5xl xxl:mr-16 xll:text-[2rem] xll:leading-[2.7rem] xll:mr-6 xl:text-[1.8rem] xl:mr-4 xl:leading-9 md:text-[1.6rem] md:leading-8 mr-5 text-[1.4rem] "
...
export const bg5Class = `[background-image:url('/img5.jpg')] md:[background-position:center top] bg-[center_left_-1500px] bg-repeat bg-cover`
export const bg6Class = `[background-image:url('/bg6.png')] bg-center bg-repeat bg-cover`
export const bg7Class = `[background-image:url('/bg7.png')] bg-cover`
