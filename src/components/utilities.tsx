...
export const h1Class = "oswald md:font-[600] font-[500] xxl:text-[4.6rem] xxl:leading-[4.5rem] xxl:mr-12 font-bold xll:text-[2.9rem] xll:mr-6 xl:text-[2.5rem] xl:mr-6 md:text-[2.3rem] md:mr-4 md:leading-[3.8rem] text-4xl mr-2 leading-[3.1rem] "
export const h2Class = "oswald md:font-[600] font-[500] xxl:text-5xl xxl:mr-16 xll:text-3xl xll:leading-[2.7rem] xll:mr-10 xl:text-[1.8rem] xl:mr-4 xl:leading-9 md:text-[1.6rem] md:leading-8 mr-5 text-[1.4rem] "

export const h2Class_V = "oswald pb-4 font-[700] xl:text-[2.5rem] md:text-4xl xl:leading-9 md:leading-8 text-3xl"
...
export const bg3Class = `[background-image:url('/bg3.jpg')] md:bg-[center_left_0px] bg-[center_left_-500px] bg-repeat bg-cover`
export const bg2Class = `[background-image:url('/bg2.jpg')] bg-center bg-cover bg-no-repeat`
export const bg4Class = `[background-image:url('/bg4.jpg')] md:bg-center bg-[center_left_-300px] bg-repeat bg-cover `
export const bg5Class = `[background-image:url('/img5.jpg')] md:bg-center bg-[center_left_-1500px] bg-repeat bg-cover`
