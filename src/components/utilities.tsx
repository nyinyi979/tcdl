...
export const bg1Class = `[background-image:url('/bg1.jpg')] bg-fixed md:bg-center bg-[center_left_-600px] bg-cover bg-repeat`
...
export const bg5Class = `[background-image:url('/img5.jpg')] bg-fixed md:[background-position:center top] bg-[center_left_-950px] bg-repeat bg-cover`
