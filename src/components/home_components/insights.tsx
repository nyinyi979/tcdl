...
export default function Insight(){
    ...
    useAnimateLeft('h6');
    useAnimateLeft('h7');
    const listClass = "xs:font-[600] font-[500] xxl:text-4xl xxl:leading-[6.4rem] xl:text-[1.7rem] lg:py-3 md:leading-[3.4rem] ssm:text-2xl xs:text-xl text-lg leading-[3.175rem]"
    return(
