...
import { useAnimateLeft, useAnimateRight, useAnimateTop } from '../utilities';
export default function Private(){
    ...
    return(
        <div className="text-white text-center img_2_bg py-20">
            <h1 id='private' className="md:text-3xl text-xl font-bold">The Private Group</h1>
            ...
            <div id='private_text' className="lg:w-5/6 w-11/12 text-justify mx-auto md:text-xl text-lg leading-8 ">
            ...
            <div id='mySwiper' className="lg:w-5/6 w-11/12 mx-auto ">
                    <blockquote id="quote" className="text-justify mx-auto md:text-2xl text-xl leading-8 py-32 my-7">
            ...
            <a id='private_btn' href="" className="block w-fit mx-auto no-underline text-lg font-semibold bg-primary hover:bg-secondary hover:text-black py-4 px-10 rounded-full">Be an Elite?</a>
        </div>
    )
}