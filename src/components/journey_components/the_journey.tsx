...
export default function TheJourney(){
    return(
        <div className="mt-10 lg:mt-0 lg:pt-0 pt-[4.5rem]">
            ...
            <div className="text-center xll:pb-20 pb-8">
                ...
                font-[600] xll:leading-[3rem] xll:text-[30px] xl:leading-10 md:text-[26px] md:py-4 
                text-[21px] leading-8`}>
                    In the midst of immense turmoils, <br />
                    there arises a quest to uncover significance.
                </h1>
                <div className={`text-white xll:w-[1140px] xl:w-[990px] llg:w-[980px] lg:w-[950px] md:w-[92%] xs:w-[88%] w-[81%] 
                font-[400] text-justify mx-auto xll:text-2xl xll:leading-[3rem] md:text-xl text-lg 
                md:leading-9 leading-8 md:pb-8 py-3`}>
