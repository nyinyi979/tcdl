...
export default function J_Carosusel(){
    return(
        <div className={`md:py-20 py-10 ${bg7Class} text-center`}>
            ...
            <div className={`block font-[400] xl:w-[84%] lg:w-[95%] md:w-[90%] w-[85%] h-fit text-justify text-white mx-auto lg:leading-[36px] leading-8 lg:text-[22px] md:text-xl text-lg py-9`}>
