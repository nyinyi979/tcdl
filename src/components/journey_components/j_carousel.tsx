...
export default function J_Carosusel(){
    ...
    hover:[background-image:url('/play-btn-hover.png')] duration-500 bg-cover lg:top-[27%] lg:left-[36%] left-[28%] top-[30%] md:left-[25%] z-10 text-6xl p-3 cursor-pointer`
    return(
        <div className={`py-20 ${bg6Class}`}>
            ...
            <div className="w-full arrow relative">
                ...
                <Swiper navigation={{nextEl: '.next', prevEl: '.prev'}} freeMode loop speed={2000} breakpoints={{0: {slidesPerView:2 , spaceBetween:50}, 640: {slidesPerView: 3, spaceBetween: 50 }}} modules={[Navigation]} className=" w-[80%] mySwiper">
