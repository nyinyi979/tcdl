...
export const headingBoxClass = "clear-both table rounded-tl-3xl rounded-tr-3xl w-full font-[400] ssm:text-3xl text-2xl ssm:pl-10 ssm:pr-6 ssm:pt-[23px] ssm:pb-[30px] pl-6 pr-2 py-4 md:mb-5 mb-3 text-white bg-gradient-to-r from-[#a2438d] to-[#5c3477]"
