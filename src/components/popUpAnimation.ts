...
export const headingBoxClass = "clear-both table rounded-tl-3xl rounded-tr-3xl w-full font-[400] ssm:text-3xl text-2xl ssm:px-10 ssm:py-[26px] px-6 py-4 ssm:mb-5 mb-3 text-white bg-gradient-to-r from-[#a2438d] to-[#5c3477]"
export const labelClass = 'z-[20] font-[400] absolute -top-2 ssm:left-[4.3rem] left-[2.3rem] block w-fit h-fit py-1 px-5 bg-white rounded-full'
