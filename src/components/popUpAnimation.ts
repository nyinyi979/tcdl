...
export const labelClass = 'z-[20] font-[500] absolute -top-2 ssm:left-[4rem] left-[2.3rem] block w-fit h-fit py-1 px-5 bg-white rounded-full text-[#696769] md:text-base text-sm'
