...
export default function Accounts(){
    ...
    const inputBoxClass = `z-10 block relative md:w-full w-[98%] ssm:px-10 px-4 mx-auto my-2 py-2 text-text_violet`
    ...
    return(
        <>
            ...
            <div className='grid lg:grid-cols-2 grid-cols-1 lg:px-5 lg:py-1 py-2 px-2 lg:gap-0 gap-1'>
                ...
                <div className={'relative grid xl:grid-cols-3 grid-cols-2 xll:gap-2 gap-1 w-[70%] mx-auto xll:py-8 py-6 text-text_violet font-[600] lg:text-lg xll:text-xl text-sm'}>
